...
<form action="{{ route('cursos.store') }}" method="POST">
    ...
    <div class="row">
        <div class="col">
            <div class="form-floating mb-3">
                <input type="text" class="form-control {{ $errors->has('sigla') ? 'is-invalid' : '' }}" name="sigla" placeholder="Sigla" value="{{old('sigla')}}" />
                @if($errors->has('sigla'))
                <div class='invalid-feedback'>
                    {{ $errors->first('sigla') }}
                </div>
    ...
    <div class="row">
        <div class="col">
            <div class="form-floating mb-3">
                <input type="number" class="form-control {{ $errors->has('tempo') ? 'is-invalid' : '' }}" name="tempo" placeholder="Tempo" value="{{old('tempo')}}" />
                @if($errors->has('tempo'))
                <div class='invalid-feedback'>
                    {{ $errors->first('tempo') }}
                </div>
                @endif
                <label for="sigla">Tempo do Curso</label>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            <div class="form-floating mb-3 ">
                ...
                @endif
                <label for="especialidade_id">Eixo do Curso</label>
            </div>
        </div>
    </div>
    <div class="row">
